        ...
        <section className="city-page">
            <div className="city-wrapper">
                ...
                <article className="city-section">
                    ...
                    <p>
                        XI asr olimlaridan Abu Rayhon Beruniy va Mahmud Qoshgʻariy shahar nomining kelib chiqishini „Semizkent“, yaʼni „semiz qishloq“ soʻzining buzib talaffuz qilinishi deb tushuntiradilar[4]. 1404-yilda Samarqandga tashrif buyurgan Ispaniya elchisi Ruy Gonsales de Klavixo ham bu talqinni qoʻllab quvvatlaydi[5].
                    </p>
                    <p>
                        Bulardan tashqari, turli davrlarda bitilgan tarixiy manba va kitoblarda shahar nomi Samariana, Saramanka, Sakanna, Sanmangan, Samakiyon, Sumron, Shamarkan, Samaroy, Simroyat kabi shakllarda ham qayd etiladi[6].
                    </p>
                    <p>
                        Fanda Samarqand toponimining yuzaga kelishi va semantikasi borasida turli xil fikr va mulohazalar keltirilgan. Ayrim xorijiy toponimistlar shahar nomi sanskritga samariya – „yigʻin“ yoki „anjuman“ soʻzidan olingan degan fikrni aytgan. „Tarixi Tabariy“, „Samariya“ va „Gʻiyos ul-lugʻot“ asarlarining mualliflari yozishlaricha, „Samar“- podshoning nomi boʻlib, „kand“ esa turkiy tilda „shahar“ degan maʼnoni anglatgan. Demak, Samarqand – Samar shahri demakdir.
                    </p>
                    {/* <div className="image-placeholder">Rasm joyi (Zarafshon vodiysi)</div> */}
                </article>

                {/* NOMLANISH TARIXI */}
                <article className="city-section">
                    <h2>Qadimgi davr va Ilk oʻrta asrlar</h2>
                    <p>
                    ...
                    {/* <div className="image-placeholder">Rasm joyi (Qadimiy Samarqand xaritasi)</div> */}
                </article>

                {/* QADIMGI DAVR */}
                <article className="city-section">
                    <h2>Turk xoqonligi va Gʻarbiy turk xoqonligi tarkibida</h2>
                    <p>
                ...
                <article className="city-section">
                    ...
                    {/* <div className="image-placeholder">Rasm joyi (Registon maydoni)</div> */}
                </article>

                <article className="city-section">
                    <h2>Moʻgʻullar hukmronligi davrida</h2>
                    <p>
                ...
                <article className="city-section">
                    <h2>Amir Temur va Temuriylar davrida</h2>
                    <p>
                        XIV asr oʻrtalarida Movarounnahrda moʻgullarga qarshi xalq harakatlari boʻlib oʻtdi. Sarbadorlar isyoni natijasida shaharda bir necha oy xalq hokimiyati oʻrnatildi. XIV asr oxiri va XV asrda Samarqand iqtisodiy-siyosiy va madaniy hayoti ancha yuksaldi. Amir Temur saltanati poytaxti sifatida Samarqand jahonga mashhur boʻldi.
                    </p>
                    <p>
                ...
                <article className="city-section">
                    ...
                    <p>
                        Shayboniylar daxmasi – Samarqanddagi oʻrta asr meʼmoriy yodgorligi (16-asr). Shayboniyxon 1510-yilda Ismoil I Safaviy bilan boʻlgan jangda halok boʻlgach, Samarqandga olib kelinib oʻzi qurgan madrasada marmar supa ostiga dafn etilgan. Supa ostiga Shayboniyxondan tashqari boshqa shayboniy sultonlar va malikalar: Mahmud Sulton (1503—04 y. oʻldirilgan), Mahdiy sulton, Hamza Sulton (1511-yil oʻldirilgan), Muhammad Temur Sulton (1511-yil v.e.), Qutlugʻ Muhammad Sulton (1545-yil v.e.), Abulxayr Sulton (1511-yil udsirilgan), Yodgor Sultonim (1526-yil v.e.), Shaxribonu xonim (1535-yil v.e.), Shoh Sulton xonim (1530-yil v.e.), Suyunch Muhammad Sulton (1586-yil v.e.) lar dafn etilgan.
                    </p>
                    <p>
                    ...
                    <p>Samarqandga oʻzbek adabiyotining shoiri va mutafakkiri, naqshbandiylar tariqati vakili Boborahim Mashrab (1657-1711) ham tashrif buyurgan.
                    </p>
                    <p>
                        1723—1730-yillarda qozoklar bosqini davrida katta talofat koʻrdi. 1740—1747-ylarda Nodirshohga tobe boʻldi. XVII asrning 1-yarmida olchin urugʻidan chiqqan oʻzbek harbiy zamindorlarining katta vakili Yalangtoʻsh Bahodir Samarqand hokimi boʻlgan. 1758—1868-yillarda esa Samarqand Buxoro amirligiga itoat qilgan.
                    </p>
                </article>

                <article className="city-section">
                    <h2>Buxoro amirligi davrida (1756-1868)</h2>
                    <p>
                ...
                <article className="city-section">
                    ...
                    <p>
                        Samarqand – aholisining soni va sanoatining koʻlami boʻyicha Oʻzbekistonda yetakchi oʻrinlardan birida. 1930-yil larda pillakashlik va shoyi toʻqish fabikalari, meva konserva zavodi, choy qadoqlash fabrikasi qurildi. 1940—1970-yillarda Samarqandda „Krasniy dvigatel“, „Kinap“, tamakifermentatsiya zavodlari, yigiruv fabrikasi, superfosfat zavodi, poyabzal va tikuvchilik fabikalari, uysozlik kombinati, chinni zavodi va boshqa korxonalar qurib ishga tushirildi.
                    </p>
                </article>

                {/* YAKUNIY */}
                <article className="city-section">
                    <h2>Zamonaviy Samarqand</h2>
                    <p>
                        Bugungi kunda Samarqand Oʻzbekistonning yirik turistik,
                        madaniy va sanoat markazlaridan biri hisoblanadi.
                        2024-yil holatiga koʻra shahar aholisi 585 ming kishidan oshgan.
                    </p>
                    <p>
                        Samarqand 2022-yilda Shanxay hamkorlik tashkiloti sammitiga mezbonlik qilgan
                        va xalqaro miqyosda yana bir bor eʼtibor markaziga aylangan.
                    </p>
                    <div className="image-placeholder">Rasm joyi (Zamonaviy Samarqand)</div>
                </article>
